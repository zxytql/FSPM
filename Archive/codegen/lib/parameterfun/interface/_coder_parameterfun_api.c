/*
 * File: _coder_parameterfun_api.c
 *
...
void parameterfun_atexit(void)
{
  ...
  parameterfun_xil_terminate();
  parameterfun_xil_shutdown();
...
/*
 * File trailer for _coder_parameterfun_api.c
 *
 * [EOF]
 */
